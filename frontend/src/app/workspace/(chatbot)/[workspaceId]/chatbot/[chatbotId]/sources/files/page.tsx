...
import { SourceUploadZone } from "@/components/sources/SourceUploadZone";
...
export default function FilesPage() {
  ...
  const uploadSource = useSourceStore((s) => s.uploadSource);
    ...
    <div className="flex h-full">
      <div className="flex-1 overflow-y-auto p-6">
        <div className="mx-auto max-w-3xl">
          <div>
            <h1 className="text-[20px] font-semibold text-[#0A0A0A]">Files</h1>
          ...
          {canEdit && (
            <div className="mt-6 rounded-xl border border-[#E4E4E7] bg-white">
              ...
              >
                <h3 className="text-[14px] font-semibold text-[#0A0A0A]">Add files</h3>
                {addOpen ? (
              ...
              {addOpen && (
                <div className="border-t border-[#E4E4E7] px-5 py-5">
                  <SourceUploadZone onUpload={handleUpload} />
                </div>
              )}
            </div>
          )}
